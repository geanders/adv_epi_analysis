...
where $Y_{t}$ is the mortality count on day $t$, $X_{t}$ is the mean temperature 
...
$g(Y)=\beta_{0}+\beta_{1}X$, where $g()$ represents the link function, in this 
case a log function so that  $log(Y)=\beta_{0}+\beta_{1}X$. We can also express 
this as $Y=exp(\beta_{0}+\beta_{1}X)$.
