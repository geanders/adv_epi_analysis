...
fhstv<-fhs %>%
  ...
  mutate(time_next=lead(time), ### bring forward the time from the next period
         ...
         agetv=age+(time/365.25)) %>% ### also create a time-varying age variable for age at beginning of each period
ungroup()
```
