...
max_agemi = max(agemi))
```
We can see that the distribution of age at incident MI hospitalization among males and females is similar, but with males being somehwat younger on average at the time of incident MI.
