...
Another alternative we could have considered is to use the BMI at the first explanation as the measure of the BMI risk factor for each study subject; if you'd like, try that out to see if it changes our main conclusions.
