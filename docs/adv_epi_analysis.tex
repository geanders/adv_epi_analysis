...
\begin{Highlighting}[]
\NormalTok{dlnm\_mod\_1 }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{crosspred}\NormalTok{(}\AttributeTok{basis =}\NormalTok{ temp\_basis, }\AttributeTok{model =}\NormalTok{ ., }\AttributeTok{cen =} \DecValTok{6}\NormalTok{, }\AttributeTok{by =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-85-1.pdf}
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-88-1.pdf}
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-115-1.pdf}
