...
One epidemiological measure that incorporates these two facets is the measure of \textbf{attributable risk}. Attributable risk aims to measure the proportion of cases of disease in a population that is attributable to an exposure---in other words, what proportion of cases would you have avoided in a population if the exposure were eliminated (or, in cases where that doesn't make sense like temperature, held at its safest level)? A number of other terms are sometimes also used to describe this idea, including \emph{population attributable risk}, \emph{attributable fraction}, and \emph{etiological fraction}.
