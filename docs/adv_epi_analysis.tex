...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model_IPW<-}\KeywordTok{glm}\NormalTok{(cursmoke}\OperatorTok{~+}\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }\DataTypeTok{family=}\StringTok{'binomial'}\NormalTok{, }\DataTypeTok{data=}\NormalTok{fhs_first)}
\NormalTok{model_IPW }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs_first <-fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{p_smokobs=}\KeywordTok{ifelse}\NormalTok{(cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{,   }\CommentTok{###estimate the conditional probability that someone is unexposed or exposed from the model above}
         \DecValTok{1} \OperatorTok{-}\StringTok{ }\KeywordTok{predict}\NormalTok{(model_IPW, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{),}
         \KeywordTok{predict}\NormalTok{(model_IPW, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{)),}
         \DataTypeTok{w=}\DecValTok{1}\OperatorTok{/}\NormalTok{p_smokobs)}\CommentTok{#### The weights is the inverse of the probability of exposure value}
...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_age=}\KeywordTok{mean}\NormalTok{(age),}
            \DataTypeTok{mean_agew=}\NormalTok{(}\KeywordTok{sum}\NormalTok{(age}\OperatorTok{*}\NormalTok{w)}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(w)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(sex}\OperatorTok{==}\DecValTok{2}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modIPW<-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedth, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }\DataTypeTok{weights=}\NormalTok{w, }\DataTypeTok{cluster =}\NormalTok{ randid,}
                    \DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{coxph_modIPW }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_smokeW <-}\StringTok{ }\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedthy, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }\DataTypeTok{weights=}\NormalTok{w, }\DataTypeTok{data =}\NormalTok{ fhs_first)}
...
\StringTok{                                }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\KeywordTok{ns}\NormalTok{(bmi, }\DataTypeTok{df =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ns}\NormalTok{(sysbp, }\DataTypeTok{df =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}
\StringTok{                                }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                              \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{cursmoke_l1=}\KeywordTok{lag}\NormalTok{(cursmoke),}
         \DataTypeTok{cursmoke_l1=}\KeywordTok{ifelse}\NormalTok{(period}\OperatorTok{==}\DecValTok{1}\NormalTok{, cursmoke, cursmoke_l1), }\CommentTok{###we are setting the lagged smoking status variable to equal the present smoking status value (we are assuming smoking status didn't change right at the beginning of follow-up)}
         \DataTypeTok{bmi_l1=}\KeywordTok{lag}\NormalTok{(bmi),}
         \DataTypeTok{bmi_l1=}\KeywordTok{ifelse}\NormalTok{(period}\OperatorTok{==}\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{, bmi_l1),}
         \DataTypeTok{sysbp_l1=}\KeywordTok{lag}\NormalTok{(sysbp),}
         \DataTypeTok{sysbp_l1=}\KeywordTok{ifelse}\NormalTok{(period}\OperatorTok{==}\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{, sysbp_l1)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod_tvIPW<-}\KeywordTok{glm}\NormalTok{(cursmoke}\OperatorTok{~}\KeywordTok{ns}\NormalTok{(time, }\DataTypeTok{df=}\DecValTok{2}\NormalTok{)}\OperatorTok{+}\NormalTok{age}\OperatorTok{+}\NormalTok{sex}\OperatorTok{+}\NormalTok{cursmoke_l1 }\OperatorTok{+}\StringTok{ }\KeywordTok{ns}\NormalTok{(bmi_l1, }\DataTypeTok{df=}\DecValTok{2}\NormalTok{)}\OperatorTok{+}\NormalTok{sysbp_l1, }\DataTypeTok{family=}\NormalTok{binomial, }\DataTypeTok{data=}\NormalTok{fhstv_incMI)}
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{p_smokobs=}\KeywordTok{ifelse}\NormalTok{(cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{,   }\CommentTok{###estimate the conditional probability that someone is unexposed or exposed from the model above}
         \DecValTok{1} \OperatorTok{-}\StringTok{ }\KeywordTok{predict}\NormalTok{(mod_tvIPW, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{),}
         \KeywordTok{predict}\NormalTok{(mod_tvIPW, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{)),}
         \DataTypeTok{w_i=}\DecValTok{1}\OperatorTok{/}\NormalTok{p_smokobs,}\CommentTok{#### This is the first step}
         \DataTypeTok{w=}\KeywordTok{cumprod}\NormalTok{(w_i)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{### the second step gives us the cumulative product of the inverse probabilities over   time. }
\StringTok{         }\KeywordTok{ungroup}\NormalTok{()}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod_tvIPWnum<-}\KeywordTok{glm}\NormalTok{(cursmoke}\OperatorTok{~}\KeywordTok{ns}\NormalTok{(time, }\DataTypeTok{df=}\DecValTok{2}\NormalTok{)}\OperatorTok{+}\NormalTok{cursmoke_l1, }\DataTypeTok{family=}\NormalTok{binomial, }\DataTypeTok{data=}\NormalTok{fhstv_incMI)}
...
\NormalTok{fhstv_incMI <-fhstv_incMI }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{p_smokobsnum=}\KeywordTok{ifelse}\NormalTok{(cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{,   }\CommentTok{###estimate the conditional probability that someone is unexposed or exposed from the model above}
         \DecValTok{1} \OperatorTok{-}\StringTok{ }\KeywordTok{predict}\NormalTok{(mod_tvIPWnum, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{),}
         \KeywordTok{predict}\NormalTok{(mod_tvIPWnum, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{)),}
         \DataTypeTok{w_i=}\NormalTok{p_smokobsnum}\OperatorTok{/}\NormalTok{p_smokobs,}\CommentTok{#### This is the first step}
         \DataTypeTok{w=}\KeywordTok{cumprod}\NormalTok{(w_i)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{### the second step gives us the cumulative product of the inverse probabilities over   time. }
\StringTok{         }\KeywordTok{ungroup}\NormalTok{()}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod_tvIPWnum<-}\KeywordTok{glm}\NormalTok{(cursmoke}\OperatorTok{~}\KeywordTok{ns}\NormalTok{(time, }\DataTypeTok{df=}\DecValTok{2}\NormalTok{)}\OperatorTok{+}\NormalTok{cursmoke_l1 }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }\DataTypeTok{family=}\NormalTok{binomial, }\DataTypeTok{data=}\NormalTok{fhstv_incMI)}
\NormalTok{mod_tvIPWnum }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{                                }\NormalTok{cursmoke }\OperatorTok{+}
\StringTok{                                }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }\DataTypeTok{weights=}\NormalTok{w, }\DataTypeTok{cluster=}\NormalTok{randid,}
                              \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model_PS<-}\KeywordTok{glm}\NormalTok{(cursmoke}\OperatorTok{~+}\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }\DataTypeTok{family=}\StringTok{'binomial'}\NormalTok{, }\DataTypeTok{data=}\NormalTok{fhs_first)}
\NormalTok{model_PS }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first <-fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ps_smok=}\KeywordTok{predict}\NormalTok{(model_PS, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{))}

\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_ps=}\KeywordTok{mean}\NormalTok{(ps_smok),}
            \DataTypeTok{max_ps=}\KeywordTok{max}\NormalTok{(ps_smok),}
            \DataTypeTok{min_ps=}\KeywordTok{min}\NormalTok{(ps_smok),}
            \DataTypeTok{sum_ps=}\KeywordTok{sum}\NormalTok{(ps_smok))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(ps_smok) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ps_smokq=}\KeywordTok{cut}\NormalTok{(ps_smok, }\DataTypeTok{breaks=}\KeywordTok{c}\NormalTok{(}\KeywordTok{quantile}\NormalTok{(ps_smok, }\DataTypeTok{probs =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DataTypeTok{by =} \FloatTok{0.25}\NormalTok{))), }
      \DataTypeTok{labels=}\KeywordTok{c}\NormalTok{(}\StringTok{"Q1"}\NormalTok{,}\StringTok{"Q2"}\NormalTok{,}\StringTok{"Q3"}\NormalTok{,}\StringTok{"Q4"}\NormalTok{), }\DataTypeTok{include.lowest=}\OtherTok{TRUE}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs_firstPSQ1<-}\StringTok{ }\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(ps_smokq}\OperatorTok{==}\StringTok{'Q1'}\NormalTok{)}

\NormalTok{coxph_modPSQ1 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timemi, hospmi) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }
                    \DataTypeTok{data =}\NormalTok{ fhs_firstPSQ1)}
\NormalTok{coxph_modPSQ1 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
...
##   term        hr low_hr high_hr
##   <chr>    <dbl>  <dbl>   <dbl>
## 1 cursmoke  1.21  0.784    1.88
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs_firstPSQ2<-}\StringTok{ }\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(ps_smokq}\OperatorTok{==}\StringTok{'Q2'}\NormalTok{)}

\NormalTok{coxph_modPSQ2 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timemi, hospmi) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }
                    \DataTypeTok{data =}\NormalTok{ fhs_firstPSQ2)}
\NormalTok{coxph_modPSQ2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
...
##   term        hr low_hr high_hr
##   <chr>    <dbl>  <dbl>   <dbl>
## 1 cursmoke  1.35  0.902    2.02
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs_firstPSQ3<-}\StringTok{ }\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(ps_smokq}\OperatorTok{==}\StringTok{'Q3'}\NormalTok{)}

\NormalTok{coxph_modPSQ3 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timemi, hospmi) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }
                    \DataTypeTok{data =}\NormalTok{ fhs_firstPSQ3)}
\NormalTok{coxph_modPSQ3 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
...
##   term        hr low_hr high_hr
##   <chr>    <dbl>  <dbl>   <dbl>
## 1 cursmoke  1.38  0.922    2.05
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs_firstPSQ4<-}\StringTok{ }\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(ps_smokq}\OperatorTok{==}\StringTok{'Q4'}\NormalTok{)}

\NormalTok{coxph_modPSQ4 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timemi, hospmi) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }
                    \DataTypeTok{data =}\NormalTok{ fhs_firstPSQ4)}
\NormalTok{coxph_modPSQ4}\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modPS <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timemi, hospmi) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{ps_smok, }
                    \DataTypeTok{data =}\NormalTok{ fhs_first)}
