...
2. How do (survival) curves for mortality compare between men and women? How about for MI?
...
\textbf{2.How do (survival) curves for mortality compare between men and women? How about for MI?}

Kaplan-Meir curves like the above are useful in comparing the survival rate between two groups. For example if we wanted to compare the survival rates between men and women we would fit the same model as above among men and women respecitvely and then compare the two.
