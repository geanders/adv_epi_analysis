...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model\_IPW}\OtherTok{\textless{}{-}}\FunctionTok{glm}\NormalTok{(cursmoke}\SpecialCharTok{\textasciitilde{}+}\NormalTok{age }\SpecialCharTok{+}\NormalTok{ sex, }\AttributeTok{family=}\StringTok{\textquotesingle{}binomial\textquotesingle{}}\NormalTok{, }\AttributeTok{data=}\NormalTok{fhs\_first)}
\NormalTok{model\_IPW }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs\_first }\OtherTok{\textless{}{-}}\NormalTok{fhs\_first }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{p\_smokobs=}\FunctionTok{ifelse}\NormalTok{(cursmoke }\SpecialCharTok{==} \DecValTok{0}\NormalTok{,   }\DocumentationTok{\#\#\#estimate the conditional probability that someone is unexposed or exposed from the model above}
         \DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{predict}\NormalTok{(model\_IPW, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{),}
         \FunctionTok{predict}\NormalTok{(model\_IPW, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)),}
         \AttributeTok{w=}\DecValTok{1}\SpecialCharTok{/}\NormalTok{p\_smokobs)}\DocumentationTok{\#\#\#\# The weights is the inverse of the probability of exposure value}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph\_modIPW}\OtherTok{\textless{}{-}} \FunctionTok{coxph}\NormalTok{(}\FunctionTok{Surv}\NormalTok{(timedth, death) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ cursmoke, }\AttributeTok{weights=}\NormalTok{w, }\AttributeTok{cluster =}\NormalTok{ randid,}
                    \AttributeTok{data =}\NormalTok{ fhs\_first)}
\NormalTok{coxph\_modIPW }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{tidy}\NormalTok{()}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit\_smokeW }\OtherTok{\textless{}{-}} \FunctionTok{survfit}\NormalTok{(}\FunctionTok{Surv}\NormalTok{(timedthy, death) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ cursmoke, }\AttributeTok{weights=}\NormalTok{w, }\AttributeTok{data =}\NormalTok{ fhs\_first)}
...
\NormalTok{                                cursmoke }\SpecialCharTok{+} \FunctionTok{ns}\NormalTok{(bmi, }\AttributeTok{df =} \DecValTok{3}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ns}\NormalTok{(sysbp, }\AttributeTok{df =} \DecValTok{3}\NormalTok{) }\SpecialCharTok{+}
\NormalTok{                                age }\SpecialCharTok{+}\NormalTok{ sex, }
                              \AttributeTok{data =}\NormalTok{ fhstv\_incMI)}
...
\NormalTok{fhstv\_incMI}\OtherTok{\textless{}{-}}\NormalTok{fhstv\_incMI }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{cursmoke\_l1=}\FunctionTok{lag}\NormalTok{(cursmoke),}
         \AttributeTok{cursmoke\_l1=}\FunctionTok{ifelse}\NormalTok{(period}\SpecialCharTok{==}\DecValTok{1}\NormalTok{, cursmoke, cursmoke\_l1), }\DocumentationTok{\#\#\#we are setting the lagged smoking status variable to equal the present smoking status value (we are assuming smoking status didn\textquotesingle{}t change right at the beginning of follow{-}up)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod\_tvIPW}\OtherTok{\textless{}{-}}\FunctionTok{glm}\NormalTok{(cursmoke}\SpecialCharTok{\textasciitilde{}}\FunctionTok{ns}\NormalTok{(time, }\AttributeTok{df=}\DecValTok{2}\NormalTok{)}\SpecialCharTok{+}\NormalTok{age}\SpecialCharTok{+}\NormalTok{sex}\SpecialCharTok{+}\NormalTok{cursmoke\_l1 }\SpecialCharTok{+} \FunctionTok{ns}\NormalTok{(bmi\_l1, }\AttributeTok{df=}\DecValTok{2}\NormalTok{)}\SpecialCharTok{+}\NormalTok{sysbp\_l1, }\AttributeTok{family=}\NormalTok{binomial, }\AttributeTok{data=}\NormalTok{fhstv\_incMI)}
...
\NormalTok{fhstv\_incMI }\OtherTok{\textless{}{-}}\NormalTok{fhstv\_incMI }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(randid) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{p\_smokobs=}\FunctionTok{ifelse}\NormalTok{(cursmoke }\SpecialCharTok{==} \DecValTok{0}\NormalTok{,   }\DocumentationTok{\#\#\#estimate the conditional probability that someone is unexposed or exposed from the model above}
         \DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{predict}\NormalTok{(mod\_tvIPW, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{),}
         \FunctionTok{predict}\NormalTok{(mod\_tvIPW, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)),}
         \AttributeTok{w\_i=}\DecValTok{1}\SpecialCharTok{/}\NormalTok{p\_smokobs,}\DocumentationTok{\#\#\#\# This is the first step}
         \AttributeTok{w=}\FunctionTok{cumprod}\NormalTok{(w\_i)) }\SpecialCharTok{\%\textgreater{}\%} \DocumentationTok{\#\#\# the second step gives us the cumulative product of the inverse probabilities over   time. }
         \FunctionTok{ungroup}\NormalTok{()}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod\_tvIPWnum}\OtherTok{\textless{}{-}}\FunctionTok{glm}\NormalTok{(cursmoke}\SpecialCharTok{\textasciitilde{}}\FunctionTok{ns}\NormalTok{(time, }\AttributeTok{df=}\DecValTok{2}\NormalTok{)}\SpecialCharTok{+}\NormalTok{cursmoke\_l1, }\AttributeTok{family=}\NormalTok{binomial, }\AttributeTok{data=}\NormalTok{fhstv\_incMI)}
...
\NormalTok{fhstv\_incMI }\OtherTok{\textless{}{-}}\NormalTok{fhstv\_incMI }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(randid) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{p\_smokobsnum=}\FunctionTok{ifelse}\NormalTok{(cursmoke }\SpecialCharTok{==} \DecValTok{0}\NormalTok{,   }\DocumentationTok{\#\#\#estimate the conditional probability that someone is unexposed or exposed from the model above}
         \DecValTok{1} \SpecialCharTok{{-}} \FunctionTok{predict}\NormalTok{(mod\_tvIPWnum, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{),}
         \FunctionTok{predict}\NormalTok{(mod\_tvIPWnum, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)),}
         \AttributeTok{w\_i=}\NormalTok{p\_smokobsnum}\SpecialCharTok{/}\NormalTok{p\_smokobs,}\DocumentationTok{\#\#\#\# This is the first step}
         \AttributeTok{w=}\FunctionTok{cumprod}\NormalTok{(w\_i)) }\SpecialCharTok{\%\textgreater{}\%} \DocumentationTok{\#\#\# the second step gives us the cumulative product of the inverse probabilities over   time. }
         \FunctionTok{ungroup}\NormalTok{()}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod\_tvIPWnum}\OtherTok{\textless{}{-}}\FunctionTok{glm}\NormalTok{(cursmoke}\SpecialCharTok{\textasciitilde{}}\FunctionTok{ns}\NormalTok{(time, }\AttributeTok{df=}\DecValTok{2}\NormalTok{)}\SpecialCharTok{+}\NormalTok{cursmoke\_l1 }\SpecialCharTok{+}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ sex, }\AttributeTok{family=}\NormalTok{binomial, }\AttributeTok{data=}\NormalTok{fhstv\_incMI)}
\NormalTok{mod\_tvIPWnum }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{                                cursmoke }\SpecialCharTok{+}
\NormalTok{                                age }\SpecialCharTok{+}\NormalTok{ sex, }\AttributeTok{weights=}\NormalTok{w, }\AttributeTok{cluster=}\NormalTok{randid,}
                              \AttributeTok{data =}\NormalTok{ fhstv\_incMI)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model\_PS}\OtherTok{\textless{}{-}}\FunctionTok{glm}\NormalTok{(cursmoke}\SpecialCharTok{\textasciitilde{}+}\NormalTok{age }\SpecialCharTok{+}\NormalTok{ sex, }\AttributeTok{family=}\StringTok{\textquotesingle{}binomial\textquotesingle{}}\NormalTok{, }\AttributeTok{data=}\NormalTok{fhs\_first)}
...
\begin{Highlighting}[]
\NormalTok{fhs\_first }\OtherTok{\textless{}{-}}\NormalTok{fhs\_first }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{ps\_smok=}\FunctionTok{predict}\NormalTok{(model\_PS, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{))}

\NormalTok{fhs\_first }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarize}\NormalTok{(}\AttributeTok{mean\_ps=}\FunctionTok{mean}\NormalTok{(ps\_smok),}
            \AttributeTok{max\_ps=}\FunctionTok{max}\NormalTok{(ps\_smok),}
            \AttributeTok{min\_ps=}\FunctionTok{min}\NormalTok{(ps\_smok),}
            \AttributeTok{sum\_ps=}\FunctionTok{sum}\NormalTok{(ps\_smok))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs\_first }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(ps\_smok) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs\_first}\OtherTok{\textless{}{-}}\NormalTok{ fhs\_first }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{ps\_smokq=}\FunctionTok{cut}\NormalTok{(ps\_smok, }\AttributeTok{breaks=}\FunctionTok{c}\NormalTok{(}\FunctionTok{quantile}\NormalTok{(ps\_smok, }\AttributeTok{probs =} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{by =} \FloatTok{0.25}\NormalTok{))), }
      \AttributeTok{labels=}\FunctionTok{c}\NormalTok{(}\StringTok{"Q1"}\NormalTok{,}\StringTok{"Q2"}\NormalTok{,}\StringTok{"Q3"}\NormalTok{,}\StringTok{"Q4"}\NormalTok{), }\AttributeTok{include.lowest=}\ConstantTok{TRUE}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs\_firstPSQ1}\OtherTok{\textless{}{-}}\NormalTok{ fhs\_first }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(ps\_smokq}\SpecialCharTok{==}\StringTok{\textquotesingle{}Q1\textquotesingle{}}\NormalTok{)}

\NormalTok{coxph\_modPSQ1 }\OtherTok{\textless{}{-}} \FunctionTok{coxph}\NormalTok{(}\FunctionTok{Surv}\NormalTok{(timemi, hospmi) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ cursmoke, }
                    \AttributeTok{data =}\NormalTok{ fhs\_firstPSQ1)}
\NormalTok{coxph\_modPSQ1 }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{tidy}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(term }\SpecialCharTok{==} \StringTok{"cursmoke"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{hr =} \FunctionTok{exp}\NormalTok{(estimate),}
         \AttributeTok{low\_ci =}\NormalTok{ estimate }\SpecialCharTok{{-}} \FloatTok{1.96} \SpecialCharTok{*}\NormalTok{ std.error, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs\_firstPSQ2}\OtherTok{\textless{}{-}}\NormalTok{ fhs\_first }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(ps\_smokq}\SpecialCharTok{==}\StringTok{\textquotesingle{}Q2\textquotesingle{}}\NormalTok{)}

\NormalTok{coxph\_modPSQ2 }\OtherTok{\textless{}{-}} \FunctionTok{coxph}\NormalTok{(}\FunctionTok{Surv}\NormalTok{(timemi, hospmi) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ cursmoke, }
                    \AttributeTok{data =}\NormalTok{ fhs\_firstPSQ2)}
\NormalTok{coxph\_modPSQ2 }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{tidy}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(term }\SpecialCharTok{==} \StringTok{"cursmoke"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{hr =} \FunctionTok{exp}\NormalTok{(estimate),}
         \AttributeTok{low\_ci =}\NormalTok{ estimate }\SpecialCharTok{{-}} \FloatTok{1.96} \SpecialCharTok{*}\NormalTok{ std.error, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs\_firstPSQ3}\OtherTok{\textless{}{-}}\NormalTok{ fhs\_first }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(ps\_smokq}\SpecialCharTok{==}\StringTok{\textquotesingle{}Q3\textquotesingle{}}\NormalTok{)}

\NormalTok{coxph\_modPSQ3 }\OtherTok{\textless{}{-}} \FunctionTok{coxph}\NormalTok{(}\FunctionTok{Surv}\NormalTok{(timemi, hospmi) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ cursmoke, }
                    \AttributeTok{data =}\NormalTok{ fhs\_firstPSQ3)}
\NormalTok{coxph\_modPSQ3 }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{tidy}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(term }\SpecialCharTok{==} \StringTok{"cursmoke"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{hr =} \FunctionTok{exp}\NormalTok{(estimate),}
         \AttributeTok{low\_ci =}\NormalTok{ estimate }\SpecialCharTok{{-}} \FloatTok{1.96} \SpecialCharTok{*}\NormalTok{ std.error, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs\_firstPSQ4}\OtherTok{\textless{}{-}}\NormalTok{ fhs\_first }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(ps\_smokq}\SpecialCharTok{==}\StringTok{\textquotesingle{}Q4\textquotesingle{}}\NormalTok{)}

\NormalTok{coxph\_modPSQ4 }\OtherTok{\textless{}{-}} \FunctionTok{coxph}\NormalTok{(}\FunctionTok{Surv}\NormalTok{(timemi, hospmi) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ cursmoke, }
                    \AttributeTok{data =}\NormalTok{ fhs\_firstPSQ4)}
\NormalTok{coxph\_modPSQ4}\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{tidy}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(term }\SpecialCharTok{==} \StringTok{"cursmoke"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{hr =} \FunctionTok{exp}\NormalTok{(estimate),}
         \AttributeTok{low\_ci =}\NormalTok{ estimate }\SpecialCharTok{{-}} \FloatTok{1.96} \SpecialCharTok{*}\NormalTok{ std.error, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph\_modPS }\OtherTok{\textless{}{-}} \FunctionTok{coxph}\NormalTok{(}\FunctionTok{Surv}\NormalTok{(timemi, hospmi) }\SpecialCharTok{\textasciitilde{}}\NormalTok{ cursmoke }\SpecialCharTok{+}\NormalTok{ ps\_smok, }
                    \AttributeTok{data =}\NormalTok{ fhs\_first)}
