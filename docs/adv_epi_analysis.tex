...
\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{agedth=}\NormalTok{age}\OperatorTok{+}\NormalTok{timedth}\OperatorTok{/}\FloatTok{365.25}\NormalTok{,}
       \DataTypeTok{timedthy=}\NormalTok{timedth}\OperatorTok{/}\FloatTok{365.25}\NormalTok{) }\CommentTok{###also creating a year time-to-death variable}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-189-1.pdf}
...
\NormalTok{fit_time }\OperatorTok{%>%}
\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab=}\StringTok{"Time to death (years)"}\NormalTok{,}\DataTypeTok{ylab=}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'Overall Survival Probablity '}\NormalTok{, }\KeywordTok{hat}\NormalTok{(S)}\OperatorTok{*}\StringTok{"(t)"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_bysex<-}\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedthy, death) }\OperatorTok{~}\StringTok{ }\NormalTok{sex, }\DataTypeTok{data=}\NormalTok{fhs_first)}
...
\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab=}\StringTok{"Time to death (years)"}\NormalTok{,}\DataTypeTok{ylab=}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'Overall Survival Probablity '}\NormalTok{, }\KeywordTok{hat}\NormalTok{(S)}\OperatorTok{*}\StringTok{"(t)"}\NormalTok{)), }\DataTypeTok{legend.labs=}\KeywordTok{c}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\StringTok{"Female"}\NormalTok{),}
...
\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab=}\StringTok{"Age (years)"}\NormalTok{,}\DataTypeTok{ylab=}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'Overall Survival Probablity '}\NormalTok{, }\KeywordTok{hat}\NormalTok{(S)}\OperatorTok{*}\StringTok{"(t)"}\NormalTok{)), }\DataTypeTok{legend.labs=}\KeywordTok{c}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\StringTok{"Female"}\NormalTok{),}
  \DataTypeTok{legend.title=}\StringTok{"Sex"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_age_MIbysex<-}\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(agemi, mi_fchd) }\OperatorTok{~}\StringTok{ }\NormalTok{sex, }\DataTypeTok{data=}\NormalTok{fhs_first )}

\NormalTok{fit_age_MIbysex }\OperatorTok{%>%}
\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab=}\StringTok{"Age (years)"}\NormalTok{,}\DataTypeTok{ylab=}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'MI Survival Probablity '}\NormalTok{, }\KeywordTok{hat}\NormalTok{(S)}\OperatorTok{*}\StringTok{"(t)"}\NormalTok{)), }\DataTypeTok{legend.labs=}\KeywordTok{c}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\StringTok{"Female"}\NormalTok{),}
  \DataTypeTok{legend.title=}\StringTok{"Sex"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_age_MIsmoking<-}\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(agemi, mi_fchd) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }\DataTypeTok{data=}\NormalTok{fhs_first )}

\NormalTok{fit_age_MIsmoking }\OperatorTok{%>%}
\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab=}\StringTok{"Age (years)"}\NormalTok{,}\DataTypeTok{ylab=}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'MI Survival Probablity '}\NormalTok{, }\KeywordTok{hat}\NormalTok{(S)}\OperatorTok{*}\StringTok{"(t)"}\NormalTok{)), }\DataTypeTok{legend.labs=}\KeywordTok{c}\NormalTok{(}\StringTok{"Non-smokers"}\NormalTok{, }\StringTok{"Smokers"}\NormalTok{),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_mod1<-}\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedth, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }\DataTypeTok{data=}\NormalTok{fhs_first)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phtest<-}\KeywordTok{cox.zph}\NormalTok{(coxph_mod1)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_mod2<-}\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedth, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{age, }\DataTypeTok{data=}\NormalTok{fhs_first)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phtest2<-}\KeywordTok{cox.zph}\NormalTok{(coxph_mod2)}
\NormalTok{phtest2}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modage1<-}\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(agedth, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }\DataTypeTok{data=}\NormalTok{fhs_first)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phtestage<-}\KeywordTok{cox.zph}\NormalTok{(coxph_modage1)}
\NormalTok{phtestage}
\end{Highlighting}
\end{Shaded}
