...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{### parameter for each lag-day}
\NormalTok{cp_dlconstant}\OperatorTok{$}\NormalTok{matfit[cp_dlconstant}\OperatorTok{$}\NormalTok{predvar}\OperatorTok{==}\DecValTok{28}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{### combined model parameter for the cumulative RR (this is the sum for all of the above parameters)}
\NormalTok{cp_dlconstant}\OperatorTok{$}\NormalTok{allfit[cp_dlconstant}\OperatorTok{$}\NormalTok{predvar}\OperatorTok{==}\DecValTok{28}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{### corresponding standard error for the cumulative RR parameter}
\NormalTok{cp_dlconstant}\OperatorTok{$}\NormalTok{allse[cp_dlconstant}\OperatorTok{$}\NormalTok{predvar}\OperatorTok{==}\DecValTok{28}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{### individual lag-day parameters}
\NormalTok{hw_smooth}\OperatorTok{$}\NormalTok{matfit}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#### individual lag-day RRs}
\NormalTok{hw_smooth}\OperatorTok{$}\NormalTok{matRRfit}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{near_threshold <-}\StringTok{ }\NormalTok{sicily }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(time }\OperatorTok{%in%}\StringTok{ }\DecValTok{34}\OperatorTok{:}\DecValTok{39}\NormalTok{)}
\NormalTok{near_threshold}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(broom)}
\NormalTok{near_thres_mod }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{near_thres_mod }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "smokban"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{rr =} \KeywordTok{exp}\NormalTok{(estimate), }
         \DataTypeTok{low_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\DataTypeTok{df =} \DecValTok{4}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\DataTypeTok{df =} \DecValTok{4}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(rr, low_rr, high_rr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{near_threshold2 <-}\StringTok{ }\NormalTok{sicily }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(time }\OperatorTok{%in%}\StringTok{ }\DecValTok{31}\OperatorTok{:}\DecValTok{42}\NormalTok{)}
\NormalTok{near_thres_mod2 <-}\StringTok{ }\KeywordTok{glm}\NormalTok{(aces }\OperatorTok{~}\StringTok{ }\KeywordTok{offset}\NormalTok{(}\KeywordTok{log}\NormalTok{(stdpop)) }\OperatorTok{+}\StringTok{ }\NormalTok{smokban, }
                      \DataTypeTok{data =}\NormalTok{ near_threshold2, }
                      \DataTypeTok{family =} \StringTok{"quasipoisson"}\NormalTok{)}
\NormalTok{near_thres_mod2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "smokban"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{rr =} \KeywordTok{exp}\NormalTok{(estimate), }
         \DataTypeTok{low_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\DataTypeTok{df =} \DecValTok{10}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\DataTypeTok{df =} \DecValTok{10}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(rr, low_rr, high_rr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{near_threshold3 <-}\StringTok{ }\NormalTok{sicily }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(time }\OperatorTok{%in%}\StringTok{ }\DecValTok{25}\OperatorTok{:}\DecValTok{48}\NormalTok{)}
\NormalTok{near_thres_mod3 <-}\StringTok{ }\KeywordTok{glm}\NormalTok{(aces }\OperatorTok{~}\StringTok{ }\KeywordTok{offset}\NormalTok{(}\KeywordTok{log}\NormalTok{(stdpop)) }\OperatorTok{+}\StringTok{ }\NormalTok{smokban, }
                      \DataTypeTok{data =}\NormalTok{ near_threshold3, }
                      \DataTypeTok{family =} \StringTok{"quasipoisson"}\NormalTok{)}
\NormalTok{near_thres_mod3 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "smokban"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{rr =} \KeywordTok{exp}\NormalTok{(estimate), }
         \DataTypeTok{low_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\DataTypeTok{df =} \DecValTok{22}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\DataTypeTok{df =} \DecValTok{22}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(rr, low_rr, high_rr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{int_ts_mod1 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "smokban"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{rr =} \KeywordTok{exp}\NormalTok{(estimate), }
         \DataTypeTok{low_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\DataTypeTok{df =} \DecValTok{56}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\DataTypeTok{df =} \DecValTok{56}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(rr, low_rr, high_rr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod_data <-}\StringTok{ }\NormalTok{int_ts_mod1 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{augment}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{stdpop =}\NormalTok{ sicily}\OperatorTok{$}\NormalTok{stdpop,}
         \DataTypeTok{aces_adj =}\NormalTok{ aces }\OperatorTok{/}\StringTok{ }\NormalTok{stdpop }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{5}\NormalTok{)) }
\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{  }
\StringTok{  }\KeywordTok{geom_polygon}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{c}\NormalTok{(}\DecValTok{37}\NormalTok{, }\DecValTok{59}\NormalTok{, }\DecValTok{59}\NormalTok{, }\DecValTok{37}\NormalTok{), }
                   \DataTypeTok{y =} \KeywordTok{c}\NormalTok{(}\OtherTok{Inf}\NormalTok{, }\OtherTok{Inf}\NormalTok{, }\OperatorTok{-}\OtherTok{Inf}\NormalTok{, }\OperatorTok{-}\OtherTok{Inf}\NormalTok{)), }
               \DataTypeTok{fill =} \StringTok{"cyan"}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.2}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ mod_data, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ time, }
                                  \DataTypeTok{y =}\NormalTok{ aces }\OperatorTok{/}\StringTok{ }\NormalTok{stdpop }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{5}\NormalTok{))) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ mod_data, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ time, }
                                 \DataTypeTok{y =} \KeywordTok{exp}\NormalTok{(.fitted) }\OperatorTok{/}\StringTok{ }\NormalTok{stdpop }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{5}\NormalTok{)), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{int_ts_mod2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "smokban"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{rr =} \KeywordTok{exp}\NormalTok{(estimate), }
         \DataTypeTok{low_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\DataTypeTok{df =} \DecValTok{55}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\DataTypeTok{df =} \DecValTok{55}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(rr, low_rr, high_rr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod_data2 <-}\StringTok{ }\NormalTok{int_ts_mod3 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{augment}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{stdpop =}\NormalTok{ sicily}\OperatorTok{$}\NormalTok{stdpop,}
         \DataTypeTok{aces_adj =}\NormalTok{ aces }\OperatorTok{/}\StringTok{ }\NormalTok{stdpop }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{5}\NormalTok{)) }
\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{  }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ mod_data2, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ time, }
                                  \DataTypeTok{y =}\NormalTok{ aces }\OperatorTok{/}\StringTok{ }\NormalTok{stdpop }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{5}\NormalTok{))) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ mod_data2, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ time, }
                                 \DataTypeTok{y =} \KeywordTok{exp}\NormalTok{(.fitted) }\OperatorTok{/}\StringTok{ }\NormalTok{stdpop }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{5}\NormalTok{)), }
            \DataTypeTok{color =} \StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{int_ts_mod3 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "smokban"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{rr =} \KeywordTok{exp}\NormalTok{(estimate), }
         \DataTypeTok{low_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\DataTypeTok{df =} \DecValTok{51}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\DataTypeTok{df =} \DecValTok{51}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(rr, low_rr, high_rr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod_data3 <-}\StringTok{ }\NormalTok{int_ts_mod4 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{augment}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{stdpop =}\NormalTok{ sicily}\OperatorTok{$}\NormalTok{stdpop,}
         \DataTypeTok{aces_adj =}\NormalTok{ aces }\OperatorTok{/}\StringTok{ }\NormalTok{stdpop }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{5}\NormalTok{)) }
\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{  }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ mod_data3, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ time, }
                                  \DataTypeTok{y =}\NormalTok{ aces }\OperatorTok{/}\StringTok{ }\NormalTok{stdpop }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{5}\NormalTok{))) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ mod_data3, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ time, }
                                 \DataTypeTok{y =} \KeywordTok{exp}\NormalTok{(.fitted) }\OperatorTok{/}\StringTok{ }\NormalTok{stdpop }\OperatorTok{*}\StringTok{ }\NormalTok{(}\DecValTok{10} \OperatorTok{^}\StringTok{ }\DecValTok{5}\NormalTok{)), }
            \DataTypeTok{color =} \StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{int_ts_mod4 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "smokban"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{rr =} \KeywordTok{exp}\NormalTok{(estimate), }
         \DataTypeTok{low_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\DataTypeTok{df =} \DecValTok{25}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\DataTypeTok{df =} \DecValTok{25}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(rr, low_rr, high_rr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(lubridate)}
\NormalTok{july_week <-}\StringTok{ }\NormalTok{obs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(date }\OperatorTok{%within%}\StringTok{ }\KeywordTok{interval}\NormalTok{(}\KeywordTok{ymd}\NormalTok{(}\StringTok{"2012-07-01"}\NormalTok{), }\KeywordTok{ymd}\NormalTok{(}\StringTok{"2012-07-07"}\NormalTok{))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(date, all, tmean)}
\NormalTok{july_week}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{crosspred}\NormalTok{(}\DataTypeTok{basis =}\NormalTok{ temp_basis, }\DataTypeTok{model =}\NormalTok{ dlnm_mod_}\DecValTok{1}\NormalTok{, }
          \DataTypeTok{cen =} \DecValTok{7}\NormalTok{, }\DataTypeTok{at =}\NormalTok{ july_week}\OperatorTok{$}\NormalTok{tmean)}\OperatorTok{$}\NormalTok{matfit}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{july_week <-}\StringTok{ }\KeywordTok{crosspred}\NormalTok{(}\DataTypeTok{basis =}\NormalTok{ temp_basis, }\DataTypeTok{model =}\NormalTok{ dlnm_mod_}\DecValTok{1}\NormalTok{, }
          \DataTypeTok{cen =} \DecValTok{7}\NormalTok{, }\DataTypeTok{at =}\NormalTok{ july_week}\OperatorTok{$}\NormalTok{tmean) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{pluck}\NormalTok{(}\StringTok{"matfit"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{as.data.frame}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rownames_to_column}\NormalTok{(}\DataTypeTok{var =} \StringTok{"tmean"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\StringTok{"beta_x"}\NormalTok{ =}\StringTok{ }\NormalTok{lag0) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{tmean =} \KeywordTok{as.numeric}\NormalTok{(tmean)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{inner_join}\NormalTok{(july_week, ., }\DataTypeTok{by =} \StringTok{"tmean"}\NormalTok{) }
\NormalTok{july_week}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{july_week <-}\StringTok{ }\NormalTok{july_week }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{attr_frac =} \DecValTok{1} \OperatorTok{-}\StringTok{ }\KeywordTok{exp}\NormalTok{(}\OperatorTok{-}\NormalTok{beta_x),}
         \DataTypeTok{attr_num =}\NormalTok{ all }\OperatorTok{*}\StringTok{ }\NormalTok{attr_frac)}
\NormalTok{july_week}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{july_week }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{tot_attr_num =} \KeywordTok{sum}\NormalTok{(attr_num), }
            \DataTypeTok{tot_attr_frac =}\NormalTok{ tot_attr_num }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(all))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{geom_col}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ all), }\DataTypeTok{fill =} \StringTok{"cyan3"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_col}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ attr_num), }\DataTypeTok{fill =} \StringTok{"cyan4"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ july_week}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ july_week}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ temp_basis, }\DataTypeTok{model =}\NormalTok{ dlnm_mod_}\DecValTok{1}\NormalTok{, }\DataTypeTok{cen =} \DecValTok{7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ july_week}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ july_week}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ temp_basis, }\DataTypeTok{model =}\NormalTok{ dlnm_mod_}\DecValTok{1}\NormalTok{, }\DataTypeTok{cen =} \DecValTok{7}\NormalTok{, }\DataTypeTok{type =} \StringTok{"an"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ july_week}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ july_week}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ temp_basis, }\DataTypeTok{model =}\NormalTok{ dlnm_mod_}\DecValTok{1}\NormalTok{, }\DataTypeTok{cen =} \DecValTok{7}\NormalTok{, }
       \DataTypeTok{type =} \StringTok{"an"}\NormalTok{, }\DataTypeTok{tot =} \OtherTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{obs_cold <-}\StringTok{ }\NormalTok{obs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(tmean }\OperatorTok{<}\StringTok{ }\DecValTok{7}\NormalTok{)}
\NormalTok{obs_hot <-}\StringTok{ }\NormalTok{obs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(tmean }\OperatorTok{>}\StringTok{ }\DecValTok{7}\NormalTok{)}

\CommentTok{# Estimate cold-related attributable risk over the study period}
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ obs_cold}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ obs_cold}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ temp_basis, }\DataTypeTok{model =}\NormalTok{ dlnm_mod_}\DecValTok{1}\NormalTok{, }
       \DataTypeTok{cen =} \DecValTok{7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ obs_cold}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ obs_cold}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ temp_basis, }\DataTypeTok{model =}\NormalTok{ dlnm_mod_}\DecValTok{1}\NormalTok{, }
       \DataTypeTok{cen =} \DecValTok{7}\NormalTok{, }\DataTypeTok{type =} \StringTok{"an"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ obs_hot}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ obs_hot}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ temp_basis, }\DataTypeTok{model =}\NormalTok{ dlnm_mod_}\DecValTok{1}\NormalTok{, }
       \DataTypeTok{cen =} \DecValTok{7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ temp_basis, }\DataTypeTok{model =}\NormalTok{ dlnm_mod_}\DecValTok{1}\NormalTok{, }
       \DataTypeTok{cen =} \DecValTok{7}\NormalTok{, }\DataTypeTok{range =} \KeywordTok{c}\NormalTok{(}\DecValTok{7}\NormalTok{, }\KeywordTok{max}\NormalTok{(obs}\OperatorTok{$}\NormalTok{tmean)), }\DataTypeTok{type =} \StringTok{"an"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{obs_an_added <-}\StringTok{ }\NormalTok{obs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(date, tmean, all) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{an =} \KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{all, }
                     \DataTypeTok{basis =}\NormalTok{ temp_basis, }\DataTypeTok{model =}\NormalTok{ dlnm_mod_}\DecValTok{1}\NormalTok{, }
                     \DataTypeTok{cen =} \DecValTok{7}\NormalTok{, }\DataTypeTok{type =} \StringTok{"an"}\NormalTok{, }\DataTypeTok{tot =} \OtherTok{FALSE}\NormalTok{))}
\NormalTok{obs_an_added}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{obs_an_added }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{temp_round =} \KeywordTok{round}\NormalTok{(tmean)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(temp_round) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{an_tot =} \KeywordTok{sum}\NormalTok{(an)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ temp_round, }\DataTypeTok{y =}\NormalTok{ an_tot)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_col}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Mean daily temperature"}\NormalTok{, }
       \DataTypeTok{y =} \StringTok{"Total attributable excess deaths on}\CharTok{\textbackslash{}n}\StringTok{days with that temperature"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{crosspred}\NormalTok{(dl_basis_}\DecValTok{4}\NormalTok{, dist_lag_mod_}\DecValTok{5}\NormalTok{, }\DataTypeTok{bylag =} \DecValTok{1}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{ptype =} \StringTok{"overall"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ dl_basis_}\DecValTok{4}\NormalTok{, }\DataTypeTok{model =}\NormalTok{ dist_lag_mod_}\DecValTok{5}\NormalTok{, }
       \DataTypeTok{cen =} \DecValTok{18}\NormalTok{, }\DataTypeTok{range =} \KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(obs}\OperatorTok{$}\NormalTok{tmean), }\DecValTok{18}\NormalTok{), }\DataTypeTok{dir =} \StringTok{"back"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ dl_basis_}\DecValTok{4}\NormalTok{, }\DataTypeTok{model =}\NormalTok{ dist_lag_mod_}\DecValTok{5}\NormalTok{, }
       \DataTypeTok{cen =} \DecValTok{18}\NormalTok{, }\DataTypeTok{range =} \KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(obs}\OperatorTok{$}\NormalTok{tmean), }\DecValTok{18}\NormalTok{), }\DataTypeTok{dir =} \StringTok{"back"}\NormalTok{, }\DataTypeTok{type =} \StringTok{"an"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ dl_basis_}\DecValTok{4}\NormalTok{, }\DataTypeTok{model =}\NormalTok{ dist_lag_mod_}\DecValTok{5}\NormalTok{, }
       \DataTypeTok{cen =} \DecValTok{18}\NormalTok{, }\DataTypeTok{range =} \KeywordTok{c}\NormalTok{(}\DecValTok{18}\NormalTok{, }\KeywordTok{max}\NormalTok{(obs}\OperatorTok{$}\NormalTok{tmean)), }\DataTypeTok{dir =} \StringTok{"back"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{attrdl}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{tmean, }\DataTypeTok{cases =}\NormalTok{ obs}\OperatorTok{$}\NormalTok{all, }
       \DataTypeTok{basis =}\NormalTok{ dl_basis_}\DecValTok{4}\NormalTok{, }\DataTypeTok{model =}\NormalTok{ dist_lag_mod_}\DecValTok{5}\NormalTok{, }
       \DataTypeTok{cen =} \DecValTok{18}\NormalTok{, }\DataTypeTok{range =} \KeywordTok{c}\NormalTok{(}\DecValTok{18}\NormalTok{, }\KeywordTok{max}\NormalTok{(obs}\OperatorTok{$}\NormalTok{tmean)), }\DataTypeTok{dir =} \StringTok{"back"}\NormalTok{, }\DataTypeTok{type =} \StringTok{"an"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{oldest_subjects <-}\StringTok{ }\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(period }\OperatorTok{==}\StringTok{ }\DecValTok{1} \OperatorTok{&}\StringTok{ }\NormalTok{age }\OperatorTok{>=}\StringTok{ }\DecValTok{69}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{pull}\NormalTok{(randid)}
\NormalTok{oldest_subjects}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(randid }\OperatorTok{%in%}\StringTok{ }\NormalTok{oldest_subjects) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, time, period, death, timedth)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(randid }\OperatorTok{%in%}\StringTok{ }\NormalTok{oldest_subjects) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, time, period, death, timedth) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{randid =} \KeywordTok{as_factor}\NormalTok{(randid), }
         \DataTypeTok{randid =} \KeywordTok{fct_reorder}\NormalTok{(randid, timedth),  }\CommentTok{# Arrange by time to death}
         \DataTypeTok{period =} \KeywordTok{as_factor}\NormalTok{(period),}
         \DataTypeTok{death =} \KeywordTok{as_factor}\NormalTok{(death),}
         \DataTypeTok{timey =}\NormalTok{ time }\OperatorTok{/}\StringTok{ }\FloatTok{365.25}\NormalTok{,                  }\CommentTok{# Convert from days to years}
         \DataTypeTok{timedthy =}\NormalTok{ timedth }\OperatorTok{/}\StringTok{ }\FloatTok{365.25}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_segment}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =} \DecValTok{0}\NormalTok{, }\DataTypeTok{xend =}\NormalTok{ timedthy, }
                   \DataTypeTok{y =}\NormalTok{ randid, }\DataTypeTok{yend =}\NormalTok{ randid), }\DataTypeTok{color =} \StringTok{"lightgray"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ timedthy, }\DataTypeTok{y =}\NormalTok{ randid, }\DataTypeTok{fill =}\NormalTok{ death), }\DataTypeTok{shape =} \DecValTok{22}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ timey, }\DataTypeTok{y =}\NormalTok{ randid, }\DataTypeTok{color =}\NormalTok{ period)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme_classic}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Time since first examination (years)"}\NormalTok{, }
       \DataTypeTok{y =} \StringTok{"Patient ID"}\NormalTok{, }
       \DataTypeTok{color =} \StringTok{"Examination}\CharTok{\textbackslash{}n}\StringTok{period"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_fill_manual}\NormalTok{(}\DataTypeTok{name =} \StringTok{""}\NormalTok{, }\DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\StringTok{"white"}\NormalTok{, }\StringTok{"black"}\NormalTok{), }
                    \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Survived}\CharTok{\textbackslash{}n}\StringTok{follow-up"}\NormalTok{, }\StringTok{"Died during}\CharTok{\textbackslash{}n}\StringTok{follow-up"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{slice}\NormalTok{(1L) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# The L after the one clarifies that this is an integer}
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{slice}\NormalTok{(}\KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# The `n()` function gives the count of rows in a group }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}
\NormalTok{fhs_last}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{count}\NormalTok{(death) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs_first <-}\StringTok{ }\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{timedthy =}\NormalTok{ timedth }\OperatorTok{/}\StringTok{ }\FloatTok{365.25}\NormalTok{, }\CommentTok{# time-to-death in years}
         \DataTypeTok{agedth =}\NormalTok{ age }\OperatorTok{+}\StringTok{ }\NormalTok{timedthy) }
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(death }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{min_agedth =} \KeywordTok{min}\NormalTok{(agedth),}
            \DataTypeTok{mean_agedth =} \KeywordTok{mean}\NormalTok{(agedth),}
            \DataTypeTok{max_agedth =} \KeywordTok{max}\NormalTok{(agedth),}
            \DataTypeTok{missing_agedth =} \KeywordTok{sum}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(agedth)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(death }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Highlighting}[]
\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(randid }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{6238}\NormalTok{, }\DecValTok{16365}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, period, bmi, cursmoke)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bmi_vs_mi <-}\StringTok{ }\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{bmi =} \KeywordTok{mean}\NormalTok{(bmi, }\DataTypeTok{rm.na =} \OtherTok{TRUE}\NormalTok{), }
            \DataTypeTok{hospmi =} \KeywordTok{first}\NormalTok{(hospmi))}
\NormalTok{bmi_vs_mi}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bmi_vs_mi }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(hospmi) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{perc_25 =} \KeywordTok{quantile}\NormalTok{(bmi, }\FloatTok{0.25}\NormalTok{, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{), }
            \DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(bmi, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{), }
            \DataTypeTok{median =} \KeywordTok{median}\NormalTok{(bmi, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{),}
            \DataTypeTok{perc_75 =} \KeywordTok{quantile}\NormalTok{(bmi, }\FloatTok{0.75}\NormalTok{, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{bmi_vs_mi }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ bmi)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{hospmi, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{, }\DataTypeTok{scale =} \StringTok{"free_y"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sample_check <-}\StringTok{ }\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{max}\NormalTok{(period }\OperatorTok{==}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{&}\StringTok{ }\OperatorTok{!}\KeywordTok{anyNA}\NormalTok{(bmi)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{pull}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{sample}\NormalTok{(}\DataTypeTok{size =} \DecValTok{20}\NormalTok{)}

\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(randid }\OperatorTok{%in%}\StringTok{ }\NormalTok{sample_check) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sex =} \KeywordTok{factor}\NormalTok{(sex, }\DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{), }\DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Male"}\NormalTok{, }\StringTok{"Female"}\NormalTok{))) }\OperatorTok{%>%}\StringTok{  }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ age, }\DataTypeTok{y =}\NormalTok{ bmi, }\DataTypeTok{color =}\NormalTok{ sex, }\DataTypeTok{group =}\NormalTok{ randid)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bmi_vs_smoke <-}\StringTok{ }\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{bmi =} \KeywordTok{mean}\NormalTok{(bmi, }\DataTypeTok{rm.na =} \OtherTok{TRUE}\NormalTok{), }
            \DataTypeTok{smoke =} \KeywordTok{max}\NormalTok{(cursmoke))}

\NormalTok{bmi_vs_smoke }\OperatorTok{%>%}\StringTok{ }
...
\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{always_no =} \KeywordTok{max}\NormalTok{(cursmoke) }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{, }
            \DataTypeTok{always_yes =} \KeywordTok{min}\NormalTok{(cursmoke) }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }
            \DataTypeTok{changes =} \OperatorTok{!}\NormalTok{((}\KeywordTok{sum}\NormalTok{(cursmoke) }\OperatorTok{/}\StringTok{ }\KeywordTok{n}\NormalTok{()) }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{always_no =} \KeywordTok{sum}\NormalTok{(always_no), }
            \DataTypeTok{always_yes =} \KeywordTok{sum}\NormalTok{(always_yes), }
            \DataTypeTok{changes =} \KeywordTok{sum}\NormalTok{(changes))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{S1 <-}\StringTok{ }\KeywordTok{Surv}\NormalTok{(}\DataTypeTok{time =}\NormalTok{ fhs_first}\OperatorTok{$}\NormalTok{timedth, }
           \DataTypeTok{event =}\NormalTok{ fhs_first}\OperatorTok{$}\NormalTok{death)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_time }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{str}\NormalTok{() }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fit_time }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab =} \StringTok{"Time to death (years)"}\NormalTok{,}
             \DataTypeTok{ylab =} \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'Overall Survival Probablity '}\NormalTok{, }
                                     \KeywordTok{hat}\NormalTok{(S)}\OperatorTok{*}\StringTok{"(t)"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_age <-}\StringTok{ }\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(agedth, death) }\OperatorTok{~}\StringTok{ }\DecValTok{1}\NormalTok{, }\DataTypeTok{data =}\NormalTok{ fhs_first)}

\NormalTok{fit_age }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab =} \StringTok{"Age (years)"}\NormalTok{,}
             \DataTypeTok{ylab =} \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'Overall Survival Probablity '}\NormalTok{,}
                                     \KeywordTok{hat}\NormalTok{(S)}\OperatorTok{*}\StringTok{"(t)"}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_bysex <-}\StringTok{ }\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedthy, death) }\OperatorTok{~}\StringTok{ }\NormalTok{sex, }\DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{fit_age_bysex <-}\StringTok{ }\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(agedth, death) }\OperatorTok{~}\StringTok{ }\NormalTok{sex, }\DataTypeTok{data =}\NormalTok{ fhs_first)}

\NormalTok{fit_bysex }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab =} \StringTok{"Time to death (years)"}\NormalTok{,}
             \DataTypeTok{ylab =} \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'Overall Survival Probablity '}\NormalTok{,}
                                     \KeywordTok{hat}\NormalTok{(S) }\OperatorTok{*}\StringTok{ "(t)"}\NormalTok{)), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_age_bysex }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab =} \StringTok{"Age (years)"}\NormalTok{,}
             \DataTypeTok{ylab =} \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'Overall Survival Probablity '}\NormalTok{,}
                                     \KeywordTok{hat}\NormalTok{(S) }\OperatorTok{*}\StringTok{ "(t)"}\NormalTok{)),}
             \DataTypeTok{legend.labs =} \KeywordTok{c}\NormalTok{(}\StringTok{"Male"}\NormalTok{, }\StringTok{"Female"}\NormalTok{),}
...
\begin{Highlighting}[]
\NormalTok{fhs_first <-}\StringTok{ }\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{timemiy =}\NormalTok{ timemi }\OperatorTok{/}\StringTok{ }\FloatTok{365.25}\NormalTok{, }
         \DataTypeTok{agemi =}\NormalTok{ age }\OperatorTok{+}\StringTok{ }\NormalTok{timemiy) }
\NormalTok{fit_age_MIbysex <-}\StringTok{ }\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(agemi, hospmi) }\OperatorTok{~}\StringTok{ }\NormalTok{sex, }\DataTypeTok{data =}\NormalTok{ fhs_first )}

\NormalTok{fit_age_MIbysex }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab =} \StringTok{"Age (years)"}\NormalTok{,}
             \DataTypeTok{ylab =} \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'MI Survival Probablity '}\NormalTok{, }
                                     \KeywordTok{hat}\NormalTok{(S) }\OperatorTok{*}\StringTok{ "(t)"}\NormalTok{)),}
             \DataTypeTok{legend.labs=}\KeywordTok{c}\NormalTok{(}\StringTok{"Male"}\NormalTok{,}\StringTok{"Female"}\NormalTok{),}
             \DataTypeTok{legend.title=}\StringTok{"Sex"}\NormalTok{)}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_age_MIsmoking <-}\StringTok{ }\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(agemi, hospmi) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }\DataTypeTok{data =}\NormalTok{ fhs_first )}

\NormalTok{fit_age_MIsmoking }\OperatorTok{%>%}
\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab =} \StringTok{"Age (years)"}\NormalTok{,}
           \DataTypeTok{ylab=}\KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'MI Survival Probablity '}\NormalTok{, }
                                 \KeywordTok{hat}\NormalTok{(S) }\OperatorTok{*}\StringTok{ "(t)"}\NormalTok{)), }
           \DataTypeTok{legend.labs=}\KeywordTok{c}\NormalTok{(}\StringTok{"Non-smokers"}\NormalTok{, }\StringTok{"Smokers"}\NormalTok{),}
           \DataTypeTok{legend.title=}\StringTok{"Smoking status at baseline"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(broom)}
\NormalTok{coxph_mod1 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_mod1 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{high_ci =}\NormalTok{ estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
         \DataTypeTok{high_hr =} \KeywordTok{exp}\NormalTok{(high_ci)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(term, hr, low_hr, high_hr)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_mod2 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedth, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{age, }
                    \DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{coxph_mod2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_mod2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modage1 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(agedth, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }\DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{coxph_modage1 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modage1 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhstv <-}\StringTok{ }\NormalTok{fhs }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{time_next =} \KeywordTok{lead}\NormalTok{(time), }\CommentTok{### bring forward the time from the next period}
         \DataTypeTok{time2 =} \KeywordTok{ifelse}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(time_next) }\OperatorTok{==}\StringTok{ }\OtherTok{FALSE}\NormalTok{,}
\NormalTok{                        time_next }\OperatorTok{-}\StringTok{ }\DecValTok{1}\NormalTok{,}
\NormalTok{                        timedth), }\CommentTok{### create a variable indicating the last day of follow-up in a given period}
         \DataTypeTok{deathtv =} \KeywordTok{ifelse}\NormalTok{(death }\OperatorTok{==}\StringTok{ }\DecValTok{1} \OperatorTok{&}\StringTok{ }\NormalTok{timedth }\OperatorTok{<=}\StringTok{ }\NormalTok{time2, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{),}
         \DataTypeTok{timemi2 =} \KeywordTok{ifelse}\NormalTok{(time2 }\OperatorTok{<=}\StringTok{ }\NormalTok{timemi, time2, timemi),}
         \DataTypeTok{hospmitv =} \KeywordTok{ifelse}\NormalTok{(hospmi }\OperatorTok{==}\StringTok{ }\DecValTok{1} \OperatorTok{&}\StringTok{ }\NormalTok{timemi }\OperatorTok{<=}\StringTok{ }\NormalTok{timemi2, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhstv }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, period, time, time_next, time2)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhstv }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(randid }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{10552}\NormalTok{, }\DecValTok{24721}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, period, time, time2, death, timedth, deathtv)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fhstv }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(randid }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{10552}\NormalTok{, }\DecValTok{24721}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, period, time, time2, hospmi, timemi, timemi2, hospmitv)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fhstv }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{tot_deaths =} \KeywordTok{sum}\NormalTok{(deathtv))}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{tot_deaths =} \KeywordTok{sum}\NormalTok{(death))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{Surv}\NormalTok{(fhstv}\OperatorTok{$}\NormalTok{time, fhstv}\OperatorTok{$}\NormalTok{time2, fhstv}\OperatorTok{$}\NormalTok{deathtv) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modtv1 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, time2, deathtv) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                      \DataTypeTok{data =}\NormalTok{ fhstv)}
\NormalTok{coxph_modtv1 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modtv1 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitv1 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhstv_incMI <-}\StringTok{ }\NormalTok{fhstv }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(prevmi }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{) }

\NormalTok{coxph_modhospmitv2 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                              }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }\DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitv2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhstv_incMI }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(timemi2 }\OperatorTok{<=}\StringTok{ }\NormalTok{time) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{pull}\NormalTok{(randid) }\CommentTok{# Identify study subjects where this is an issue}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fhstv_incMI }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(randid }\OperatorTok{==}\StringTok{ '1338446'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{ (randid, period, time, timemi2, timemi, hospmi, hospmitv)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitv2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhstv <-}\StringTok{ }\NormalTok{fhstv }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{previous_smoking =} \KeywordTok{cummax}\NormalTok{(cursmoke)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}

\NormalTok{fhstv }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(randid }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{16365}\NormalTok{, }\DecValTok{67905}\NormalTok{, }\DecValTok{68397}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# Show for some examples where smoking status changed}
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, period, cursmoke, previous_smoking)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fhstv <-}\StringTok{ }\NormalTok{fhstv }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{smoking =} \KeywordTok{case_when}\NormalTok{(}
\NormalTok{    cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{1} \OperatorTok{~}\StringTok{ "current"}\NormalTok{, }
\NormalTok{    cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{0} \OperatorTok{&}\StringTok{ }\NormalTok{previous_smoking }\OperatorTok{==}\StringTok{ }\DecValTok{1} \OperatorTok{~}\StringTok{ "former"}\NormalTok{,}
\NormalTok{    cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{0} \OperatorTok{&}\StringTok{ }\NormalTok{previous_smoking }\OperatorTok{==}\StringTok{ }\DecValTok{0} \OperatorTok{~}\StringTok{ "never"}\NormalTok{, }
    \OtherTok{TRUE} \OperatorTok{~}\StringTok{ }\OtherTok{NA_character_} \CommentTok{# This is a catch-all, in case there are any cases missed by the earlier logic}
\NormalTok{                             ),}
    \DataTypeTok{smoking =} \KeywordTok{as_factor}\NormalTok{(smoking),  }\CommentTok{# Change to a factor}
    \DataTypeTok{smoking =} \KeywordTok{fct_relevel}\NormalTok{(smoking, }\StringTok{"never"}\NormalTok{, }\StringTok{"former"}\NormalTok{, }\StringTok{"current"}\NormalTok{)) }\CommentTok{# Get factor levels in desired order (to ensure "never" is the baseline)}

\NormalTok{fhstv }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(randid }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{16365}\NormalTok{, }\DecValTok{67905}\NormalTok{, }\DecValTok{68397}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# Show for some examples where smoking status changed}
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, period, cursmoke, previous_smoking, smoking)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modtv2 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, time2, deathtv) }\OperatorTok{~}\StringTok{ }\NormalTok{smoking }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                    \DataTypeTok{data =}\NormalTok{ fhstv)}
\NormalTok{coxph_modtv2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modtv2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(term, }\StringTok{"smoking"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{high_ci =}\NormalTok{ estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
...
\NormalTok{coxph_modhospmitv3 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                              }\NormalTok{smoking }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                            \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\NormalTok{coxph_modhospmitv3 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitv3 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(term, }\StringTok{"smoking"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{high_ci =}\NormalTok{ estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitv4 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                              }\NormalTok{smoking }\OperatorTok{+}\StringTok{ }\NormalTok{cigpday }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                            \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\NormalTok{coxph_modhospmitv4 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitv4 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ 'cigpday'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{high_ci =}\NormalTok{ estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhstv_incMI<-fhstv_incMI }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{smokingcurrent =} \KeywordTok{ifelse}\NormalTok{(smoking }\OperatorTok{==}\StringTok{ 'current'}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{),}
         \DataTypeTok{smokingformer =} \KeywordTok{ifelse}\NormalTok{(smoking }\OperatorTok{==}\StringTok{ 'former'}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{),}
         \DataTypeTok{smokingnever =} \KeywordTok{ifelse}\NormalTok{(smoking }\OperatorTok{==}\StringTok{ 'never'}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{))}

\NormalTok{coxph_modhospmitv5 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                              }\NormalTok{smokingformer }\OperatorTok{+}\StringTok{ }\NormalTok{smokingcurrent}\OperatorTok{:}\NormalTok{cigpday }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex,}
                            \DataTypeTok{data =}\NormalTok{ fhstv_incMI) }\CommentTok{###leaving the dummy variable for 'never' out makes 'never' the default comparison group}
\NormalTok{coxph_modhospmitv5 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitv5 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ 'smokingcurrent:cigpday'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{high_ci =}\NormalTok{ estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
...
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ 'smokingcurrent:cigpday'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(}\DecValTok{20} \OperatorTok{*}\StringTok{ }\NormalTok{estimate),}
         \DataTypeTok{low_ci =} \DecValTok{20} \OperatorTok{*}\StringTok{ }\NormalTok{(estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_ci =} \DecValTok{20} \OperatorTok{*}\StringTok{ }\NormalTok{(estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
         \DataTypeTok{high_hr =} \KeywordTok{exp}\NormalTok{(high_ci)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(term, hr, low_hr, high_hr)}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhstv_incMI <-}\StringTok{ }\NormalTok{fhstv_incMI }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{smokingint =} \KeywordTok{case_when}\NormalTok{(}
\NormalTok{    cigpday }\OperatorTok{==}\StringTok{ }\DecValTok{0} \OperatorTok{~}\StringTok{ "None"}\NormalTok{, }
    \DecValTok{0} \OperatorTok{<}\StringTok{ }\NormalTok{cigpday }\OperatorTok{&}\StringTok{ }\NormalTok{cigpday }\OperatorTok{<=}\StringTok{ }\DecValTok{5} \OperatorTok{~}\StringTok{ "Light"}\NormalTok{, }
    \DecValTok{5} \OperatorTok{<}\StringTok{ }\NormalTok{cigpday }\OperatorTok{&}\StringTok{ }\NormalTok{cigpday }\OperatorTok{<=}\StringTok{ }\DecValTok{10} \OperatorTok{~}\StringTok{ "Moderate"}\NormalTok{, }
    \DecValTok{10} \OperatorTok{<}\StringTok{ }\NormalTok{cigpday }\OperatorTok{&}\StringTok{ }\NormalTok{cigpday }\OperatorTok{<=}\StringTok{ }\DecValTok{20} \OperatorTok{~}\StringTok{ "Heavy"}\NormalTok{, }
    \DecValTok{20} \OperatorTok{<}\StringTok{ }\NormalTok{cigpday }\OperatorTok{~}\StringTok{ "Very Heavy"}\NormalTok{,}
    \OtherTok{TRUE} \OperatorTok{~}\StringTok{ }\OtherTok{NA_character_}
\NormalTok{                                ),}
    \DataTypeTok{smokingint =} \KeywordTok{as_factor}\NormalTok{(smokingint), }
    \DataTypeTok{smokingint =} \KeywordTok{fct_relevel}\NormalTok{(smokingint, }
...
\begin{Highlighting}[]
\NormalTok{fhstv_incMI }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, cigpday, smokingint)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitv6 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                              }\NormalTok{smokingformer }\OperatorTok{+}\StringTok{ }\NormalTok{smokingcurrent}\OperatorTok{:}\NormalTok{smokingint }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                            \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\NormalTok{coxph_modhospmitv6 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitv6 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{str_detect}\NormalTok{(term, }\StringTok{"smokingcurrent:smokingint[HLMV]"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ (estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_ci =}\NormalTok{ (estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitvBMI <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }\NormalTok{bmi }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                              \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\NormalTok{coxph_modhospmitvBMI }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitvBMI }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ 'bmi'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ (estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_ci =}\NormalTok{ (estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(splines)}
\NormalTok{coxph_modhospmitvBMIsp <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                                  }\KeywordTok{ns}\NormalTok{(bmi, }\DataTypeTok{df =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                                \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\NormalTok{coxph_modhospmitvBMIsp }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{predbmi <-}\StringTok{ }\KeywordTok{termplot}\NormalTok{(coxph_modhospmitvBMIsp, }\DataTypeTok{se =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{plot =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{pluck}\NormalTok{(}\StringTok{"bmi"}\NormalTok{)}
\NormalTok{predbmi }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =} \KeywordTok{exp}\NormalTok{(y))) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"BMI"}\NormalTok{, }
       \DataTypeTok{y =} \StringTok{"Hazard Ratio"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_hline}\NormalTok{(}\DataTypeTok{yintercept =} \FloatTok{1.0}\NormalTok{, }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{linetype =} \DecValTok{2}\NormalTok{)  }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{predbmi <-}\StringTok{ }\NormalTok{predbmi }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{center =}\NormalTok{ y[x }\OperatorTok{==}\StringTok{ }\FloatTok{22.5}\NormalTok{],}
         \DataTypeTok{ylow =}\NormalTok{ y }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{se,}
         \DataTypeTok{yhigh =}\NormalTok{ y }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{se)}

\NormalTok{predbmi }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =} \KeywordTok{exp}\NormalTok{(y }\OperatorTok{-}\StringTok{ }\NormalTok{center))) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"BMI"}\NormalTok{, }
       \DataTypeTok{y =} \StringTok{"Hazard Ratio"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_hline}\NormalTok{(}\DataTypeTok{yintercept =} \FloatTok{1.0}\NormalTok{, }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{linetype =} \DecValTok{2}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_ribbon}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin =} \KeywordTok{exp}\NormalTok{(ylow }\OperatorTok{-}\StringTok{ }\NormalTok{center), }\DataTypeTok{ymax =} \KeywordTok{exp}\NormalTok{(yhigh }\OperatorTok{-}\StringTok{ }\NormalTok{center)), }
...
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{trans =} \StringTok{'log2'}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitvBMIBP <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                                  }\KeywordTok{ns}\NormalTok{(bmi, }\DataTypeTok{df =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}\StringTok{ }\NormalTok{sysbp }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex,}
                                \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\NormalTok{coxph_modhospmitvBMIBP }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{coxph_modhospmitvBMIBP }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{tidy}\NormalTok{()}\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ 'sysbp'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ (estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_ci =}\NormalTok{ (estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitvBMIBPsp <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                                    }\KeywordTok{ns}\NormalTok{(bmi, }\DataTypeTok{df =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ns}\NormalTok{(sysbp, }\DataTypeTok{df =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                                  \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\NormalTok{coxph_modhospmitvBMIBPsp }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{predsysbp <-}\StringTok{ }\KeywordTok{termplot}\NormalTok{(coxph_modhospmitvBMIBPsp, }\DataTypeTok{se=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{plot=}\OtherTok{FALSE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{pluck}\NormalTok{(}\StringTok{"sysbp"}\NormalTok{)}
\NormalTok{predsysbp <-}\StringTok{ }\NormalTok{predsysbp }\OperatorTok{%>%}\StringTok{  }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{center =}\NormalTok{ y[x}\OperatorTok{==}\DecValTok{110}\NormalTok{],}
         \DataTypeTok{ylow =}\NormalTok{ y }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{se,}
         \DataTypeTok{yhigh =}\NormalTok{ y }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{se)}

\NormalTok{predsysbp }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ x, }\DataTypeTok{y =} \KeywordTok{exp}\NormalTok{(y}\OperatorTok{-}\NormalTok{center))) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Systolic Blood Pressure"}\NormalTok{, }
       \DataTypeTok{y =} \StringTok{"Hazard Ratio"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_hline}\NormalTok{(}\DataTypeTok{yintercept =} \FloatTok{1.0}\NormalTok{, }\DataTypeTok{color =} \StringTok{"red"}\NormalTok{, }\DataTypeTok{linetype =} \DecValTok{2}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_ribbon}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin =} \KeywordTok{exp}\NormalTok{(ylow }\OperatorTok{-}\StringTok{ }\NormalTok{center), }\DataTypeTok{ymax =} \KeywordTok{exp}\NormalTok{(yhigh }\OperatorTok{-}\StringTok{ }\NormalTok{center)), }
              \DataTypeTok{alpha =} \FloatTok{0.1}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitvall <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                                }\NormalTok{smoking }\OperatorTok{+}\StringTok{ }\KeywordTok{ns}\NormalTok{(bmi, }\DataTypeTok{df =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ns}\NormalTok{(sysbp, }\DataTypeTok{df =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}
\StringTok{                                }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                              \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\NormalTok{coxph_modhospmitvall }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modhospmitvall }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ 'smokingcurrent'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ (estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_ci =}\NormalTok{ (estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{timedthy =}\NormalTok{ timedth }\OperatorTok{/}\StringTok{ }\FloatTok{365.25}\NormalTok{,}
         \DataTypeTok{timemiy =}\NormalTok{ timemi }\OperatorTok{/}\StringTok{ }\FloatTok{365.25}\NormalTok{,}
         \DataTypeTok{agedth =}\NormalTok{ age }\OperatorTok{+}\StringTok{ }\NormalTok{timedthy) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{###Fit Cox model for current smoking status unconditional and conditional on age and sex}
\NormalTok{coxph_mod1 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timemi, hospmi) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }
                    \DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{coxph_mod1 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_mod2 <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timemi, hospmi) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{age, }
                    \DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{coxph_mod2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(cursmoke) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{n_male =} \KeywordTok{sum}\NormalTok{(sex }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{), }
            \DataTypeTok{n_female =} \KeywordTok{sum}\NormalTok{(sex }\OperatorTok{==}\StringTok{ }\DecValTok{2}\NormalTok{), }
            \DataTypeTok{perc_male =}\NormalTok{ n_male }\OperatorTok{/}\StringTok{ }\KeywordTok{n}\NormalTok{())}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_age =} \KeywordTok{mean}\NormalTok{(age), }
            \DataTypeTok{median_age =} \KeywordTok{median}\NormalTok{(age),}
            \DataTypeTok{perc25_age =} \KeywordTok{quantile}\NormalTok{(age, }\FloatTok{0.25}\NormalTok{), }
            \DataTypeTok{perc75_age =} \KeywordTok{quantile}\NormalTok{(age, }\FloatTok{0.75}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_age_smoker =} \KeywordTok{mean}\NormalTok{(age[cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{]), }
            \DataTypeTok{mean_age_nonsmoker =} \KeywordTok{mean}\NormalTok{(age[cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{]), }
            \DataTypeTok{sd_age =} \KeywordTok{sd}\NormalTok{(age)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{stand_diff_age =} \KeywordTok{abs}\NormalTok{(mean_age_smoker }\OperatorTok{-}\StringTok{ }\NormalTok{mean_age_nonsmoker) }\OperatorTok{/}\StringTok{ }\NormalTok{sd_age) }\OperatorTok{%>%}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model_ps <-}\StringTok{ }\KeywordTok{glm}\NormalTok{(cursmoke }\OperatorTok{~}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                \DataTypeTok{family =} \StringTok{"binomial"}\NormalTok{, }\DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{model_ps }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first <-}\StringTok{ }\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ps =} \KeywordTok{predict}\NormalTok{(model_ps, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{))}

\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, sex, age, ps) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ ps)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_histogram}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first <-}\StringTok{ }\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{w =} \KeywordTok{if_else}\NormalTok{(cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{ps, }\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{ps)))}

\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, age, sex, cursmoke, ps, w) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{group_by}\NormalTok{(cursmoke) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_age =} \KeywordTok{mean}\NormalTok{(age), }
            \DataTypeTok{wt_mean_age =} \KeywordTok{weighted.mean}\NormalTok{(age, }\DataTypeTok{w =}\NormalTok{ w), }
            \DataTypeTok{mean_sex =} \KeywordTok{mean}\NormalTok{(sex),}
            \DataTypeTok{wt_mean_sex =} \KeywordTok{weighted.mean}\NormalTok{(sex, }\DataTypeTok{w =}\NormalTok{ w))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_w =} \KeywordTok{mean}\NormalTok{(w),}
            \DataTypeTok{max_w =} \KeywordTok{max}\NormalTok{(w),}
            \DataTypeTok{min_w =} \KeywordTok{min}\NormalTok{(w),}
            \DataTypeTok{sum_w =} \KeywordTok{sum}\NormalTok{(w))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_age =} \KeywordTok{mean}\NormalTok{(age),}
            \DataTypeTok{mean_agew =}\NormalTok{ (}\KeywordTok{sum}\NormalTok{(age }\OperatorTok{*}\StringTok{ }\NormalTok{w) }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(w)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(sex }\OperatorTok{==}\StringTok{ }\DecValTok{2}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{femalecount =} \KeywordTok{n}\NormalTok{(),}
            \DataTypeTok{femalecountw =} \KeywordTok{sum}\NormalTok{(w))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{###Fit Cox weighted model for current smoking status}
\NormalTok{coxph_modIPW <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedth, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }\DataTypeTok{weights=}\NormalTok{w,}
                    \DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{coxph_modIPW }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modIPW }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modIPW <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedth, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }
                     \DataTypeTok{weights =}\NormalTok{ w, }\DataTypeTok{cluster =}\NormalTok{ randid,}
                    \DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{coxph_modIPW }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{robust.se, }
         \DataTypeTok{high_ci =}\NormalTok{ estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{robust.se, }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
         \DataTypeTok{high_hr =} \KeywordTok{exp}\NormalTok{(high_ci)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(term, hr, low_hr, high_hr)}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_smoke <-}\StringTok{ }\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedthy, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }\DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{fit_smoke }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab =} \StringTok{"Time to death (years)"}\NormalTok{,}
             \DataTypeTok{ylab =} \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'Overall Survival Probablity '}\NormalTok{, }
                                     \KeywordTok{hat}\NormalTok{(S)}\OperatorTok{*}\StringTok{"(t)"}\NormalTok{)))}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit_smokeW <-}\StringTok{ }\KeywordTok{survfit}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timedthy, death) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke, }
                      \DataTypeTok{weights =}\NormalTok{ w, }\DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{fit_smokeW }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggsurvplot}\NormalTok{(}\DataTypeTok{xlab =} \StringTok{"Time to death (years)"}\NormalTok{,}
             \DataTypeTok{ylab =} \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{'Overall Survival Probablity '}\NormalTok{, }
                                     \KeywordTok{hat}\NormalTok{(S)}\OperatorTok{*}\StringTok{"(t)"}\NormalTok{)))}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modtvMI <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                         }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\KeywordTok{ns}\NormalTok{(bmi, }\DataTypeTok{df =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{                         }\KeywordTok{ns}\NormalTok{(sysbp, }\DataTypeTok{df =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                              \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\NormalTok{coxph_modtvMI }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modtvMI }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ 'cursmoke'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ (estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{high_ci =}\NormalTok{ (estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhstv_incMI <-}\StringTok{ }\NormalTok{fhstv_incMI }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{cursmoke_l1 =} \KeywordTok{lag}\NormalTok{(cursmoke),}
         \CommentTok{## We will set the lagged smoking status variable to equal the present}
         \CommentTok{## smoking status for the first period (we are assuming smoking status}
         \CommentTok{## didn't change right at the beginning of follow-up, and we don't }
         \CommentTok{## have any information about smoking before the first exam)}
         \DataTypeTok{cursmoke_l1 =} \KeywordTok{if_else}\NormalTok{(period }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, cursmoke, cursmoke_l1), }
         \DataTypeTok{bmi_l1 =} \KeywordTok{lag}\NormalTok{(bmi),}
         \DataTypeTok{bmi_l1 =} \KeywordTok{ifelse}\NormalTok{(period }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{, bmi_l1),}
         \DataTypeTok{sysbp_l1 =} \KeywordTok{lag}\NormalTok{(sysbp),}
         \DataTypeTok{sysbp_l1 =} \KeywordTok{ifelse}\NormalTok{(period }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{, sysbp_l1)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(cursmoke_l1) }\OperatorTok{&}\StringTok{ }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(bmi_l1) }\OperatorTok{&}\StringTok{ }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(sysbp_l1)) }\CommentTok{### removing missing values for exposure and }
\CommentTok{## covariates. When fitting the conditional model these values are just dropped anyway, but in the weight estimation}
\CommentTok{## the missing values create a problem in the cumulative product part of the weight estimation so we are dropping }
\CommentTok{## them here}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod_tvIPW <-}\StringTok{ }\KeywordTok{glm}\NormalTok{(cursmoke }\OperatorTok{~}\StringTok{ }\KeywordTok{ns}\NormalTok{(time, }\DataTypeTok{df =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }
\StringTok{                   }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{cursmoke_l1 }\OperatorTok{+}\StringTok{ }\KeywordTok{ns}\NormalTok{(bmi_l1, }\DataTypeTok{df =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}
\StringTok{                   }\NormalTok{sysbp_l1, }\DataTypeTok{family =}\NormalTok{ binomial, }\DataTypeTok{data =}\NormalTok{ fhstv_incMI)}

\NormalTok{mod_tvIPW }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    ...
    \DataTypeTok{ps =} \KeywordTok{predict}\NormalTok{(mod_tvIPW, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{), }
    ...
    \DataTypeTok{w_i =} \KeywordTok{if_else}\NormalTok{(cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{ps, }\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{ps))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \CommentTok{# Get the cumulative product of the inverse probabilities over time}
    \CommentTok{# for each study subject}
    \DataTypeTok{w =} \KeywordTok{cumprod}\NormalTok{(w_i)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod_tvIPWnum <-}\StringTok{ }\KeywordTok{glm}\NormalTok{(cursmoke }\OperatorTok{~}\StringTok{ }\KeywordTok{ns}\NormalTok{(time, }\DataTypeTok{df =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }\NormalTok{cursmoke_l1, }
                    \DataTypeTok{family =}\NormalTok{ binomial, }\DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
\NormalTok{mod_tvIPWnum }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    ...
    \DataTypeTok{ps_new =} \KeywordTok{predict}\NormalTok{(mod_tvIPWnum, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{), }
    \CommentTok{# Estimate the new inverse probability weights from the old and new }
    \CommentTok{# propensity scores}
    \DataTypeTok{w_i_new =} \KeywordTok{if_else}\NormalTok{(cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, ps_new }\OperatorTok{/}\StringTok{ }\NormalTok{ps, (}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{ps_new) }\OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{ps))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \CommentTok{# Get the cumulative product of the inverse probabilities over time}
    \CommentTok{# for each study subject based on these weighted scores}
    \DataTypeTok{w_new =} \KeywordTok{cumprod}\NormalTok{(w_i_new)}
\NormalTok{  ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}

\NormalTok{fhstv_incMI }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_w_new =} \KeywordTok{mean}\NormalTok{(w_new),}
            \DataTypeTok{min_w_new =} \KeywordTok{min}\NormalTok{(w_new),}
            \DataTypeTok{max_w_new =} \KeywordTok{max}\NormalTok{(w_new),}
            \DataTypeTok{sum_w_new =} \KeywordTok{sum}\NormalTok{(w_new))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mod_tvIPWnum <-}\StringTok{ }\KeywordTok{glm}\NormalTok{(cursmoke }\OperatorTok{~}\StringTok{ }\KeywordTok{ns}\NormalTok{(time, }\DataTypeTok{df =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }\NormalTok{cursmoke_l1 }\OperatorTok{+}\StringTok{ }
\StringTok{                      }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }\DataTypeTok{family =}\NormalTok{ binomial, }
                    \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \CommentTok{# Estimate the new propensity scores}
    \DataTypeTok{ps_new2 =} \KeywordTok{predict}\NormalTok{(mod_tvIPWnum, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{), }
    \CommentTok{# Estimate the new inverse probability weights from the old and new }
    \CommentTok{# propensity scores}
    \DataTypeTok{w_i_new2 =} \KeywordTok{if_else}\NormalTok{(cursmoke }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, ps_new2 }\OperatorTok{/}\StringTok{ }\NormalTok{ps, (}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{ps_new2) }\OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{ps))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \CommentTok{# Get the cumulative product of the inverse probabilities over time}
    \CommentTok{# for each study subject based on these weighted scores}
    \DataTypeTok{w_new2 =} \KeywordTok{cumprod}\NormalTok{(w_i_new2)}
\NormalTok{  ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}

\NormalTok{fhstv_incMI }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_w_new2 =} \KeywordTok{mean}\NormalTok{(w_new2),}
            \DataTypeTok{min_w_new2 =} \KeywordTok{min}\NormalTok{(w_new2),}
            \DataTypeTok{max_w_new2 =} \KeywordTok{max}\NormalTok{(w_new2),}
            \DataTypeTok{sum_w_new2 =} \KeywordTok{sum}\NormalTok{(w_new2))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modtvMIipw <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(time, timemi2, hospmitv) }\OperatorTok{~}\StringTok{ }
\StringTok{                                }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex, }
                          \DataTypeTok{weights =}\NormalTok{ w_new2, }\DataTypeTok{cluster =}\NormalTok{ randid,}
                          \DataTypeTok{data =}\NormalTok{ fhstv_incMI)}

\NormalTok{coxph_modtvMIipw }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modtvMIipw }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ 'cursmoke'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ (estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{robust.se), }
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_ps =} \KeywordTok{mean}\NormalTok{(ps),}
            \DataTypeTok{max_ps =} \KeywordTok{max}\NormalTok{(ps),}
            \DataTypeTok{min_ps =} \KeywordTok{min}\NormalTok{(ps),}
            \DataTypeTok{sum_ps =} \KeywordTok{sum}\NormalTok{(ps))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(ps) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs_first <-}\StringTok{ }\NormalTok{fhs_first }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ps_smokq =} \KeywordTok{case_when}\NormalTok{(}
\NormalTok{    ps }\OperatorTok{<=}\StringTok{ }\KeywordTok{quantile}\NormalTok{(ps, }\FloatTok{0.25}\NormalTok{) }\OperatorTok{~}\StringTok{ "Q1"}\NormalTok{, }
\NormalTok{    ps }\OperatorTok{<=}\StringTok{ }\KeywordTok{quantile}\NormalTok{(ps, }\FloatTok{0.5}\NormalTok{)  }\OperatorTok{~}\StringTok{ "Q2"}\NormalTok{, }
\NormalTok{    ps }\OperatorTok{<=}\StringTok{ }\KeywordTok{quantile}\NormalTok{(ps, }\FloatTok{0.75}\NormalTok{) }\OperatorTok{~}\StringTok{ "Q3"}\NormalTok{, }
\NormalTok{    ps }\OperatorTok{<=}\StringTok{ }\KeywordTok{max}\NormalTok{(ps)            }\OperatorTok{~}\StringTok{ "Q4"}\NormalTok{, }
    \OtherTok{TRUE} \OperatorTok{~}\StringTok{ }\OtherTok{NA_character_}
\NormalTok{  )) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ps_smokq =} \KeywordTok{as_factor}\NormalTok{(ps_smokq), }
         \DataTypeTok{ps_smokq =} \KeywordTok{fct_relevel}\NormalTok{(ps_smokq, }\StringTok{"Q1"}\NormalTok{, }\StringTok{"Q2"}\NormalTok{, }\StringTok{"Q3"}\NormalTok{, }\StringTok{"Q4"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(ps, ps_smokq)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(purrr)}
\NormalTok{cox_ps_quantiles <-}\StringTok{ }\NormalTok{fhs_first }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(ps_smokq) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{nest}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{cox_mod_quartile =} \KeywordTok{map}\NormalTok{(data, }
                                \DataTypeTok{.f =} \OperatorTok{~}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timemi, hospmi) }\OperatorTok{~}\StringTok{ }
\StringTok{                                               }\NormalTok{cursmoke, }
                                             \DataTypeTok{data =}\NormalTok{ .x)),}
         \DataTypeTok{tidy_coxph =} \KeywordTok{map}\NormalTok{(cox_mod_quartile, }\DataTypeTok{.f =}\NormalTok{ tidy)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{c}\NormalTok{(data, cox_mod_quartile)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{unnest}\NormalTok{(}\DataTypeTok{cols =}\NormalTok{ tidy_coxph) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(ps_smokq) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{high_ci =}\NormalTok{ estimate }\OperatorTok{+}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
         \DataTypeTok{low_hr =} \KeywordTok{exp}\NormalTok{(low_ci), }
         \DataTypeTok{high_hr =} \KeywordTok{exp}\NormalTok{(high_ci)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(ps_smokq, hr, low_hr, high_hr)}

\NormalTok{cox_ps_quantiles}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coxph_modPS <-}\StringTok{ }\KeywordTok{coxph}\NormalTok{(}\KeywordTok{Surv}\NormalTok{(timemi, hospmi) }\OperatorTok{~}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{ps, }
                    \DataTypeTok{data =}\NormalTok{ fhs_first)}
\NormalTok{coxph_modPS }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "cursmoke"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hr =} \KeywordTok{exp}\NormalTok{(estimate),}
         \DataTypeTok{low_ci =}\NormalTok{ estimate }\OperatorTok{-}\StringTok{ }\FloatTok{1.96} \OperatorTok{*}\StringTok{ }\NormalTok{std.error, }
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(tidyverse) }\CommentTok{# Loads all the tidyverse packages, including readr}
\NormalTok{fhs <-}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(}\StringTok{"data/frmgham2.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{rename_all}\NormalTok{(str_to_lower)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{416}\NormalTok{)}
\NormalTok{fhs_sample <-}\StringTok{ }\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\CommentTok{# Relabel factor levels}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sex =} \KeywordTok{as_factor}\NormalTok{(sex),}
         \DataTypeTok{sex =} \KeywordTok{fct_recode}\NormalTok{(sex, }
                          \DataTypeTok{male =} \StringTok{"1"}\NormalTok{, }
                          \DataTypeTok{female =} \StringTok{"2"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\CommentTok{# Calculate baseline age and number of observations for each study subject}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{n =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\CommentTok{# Filter to only subjects with three examinations}
\StringTok{  }\KeywordTok{filter}\NormalTok{(n }\OperatorTok{==}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\CommentTok{# Limit to just the columns we'll use (to make the dataset simpler)}
\StringTok{  }\KeywordTok{select}\NormalTok{(randid, period, sex, age, sysbp,cursmoke, bmi, educ, time) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\CommentTok{# Nest the data, so there's one row per study subject, so we can sample }
\StringTok{  }\CommentTok{# by subject}
\StringTok{  }\KeywordTok{nest}\NormalTok{(}\DataTypeTok{cols =} \OperatorTok{-}\NormalTok{randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\CommentTok{# Sample a few study subjects}
\StringTok{  }\KeywordTok{slice_sample}\NormalTok{(}\DataTypeTok{n =} \DecValTok{15}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\CommentTok{# Unnest, to get back to one row per measurement}
\StringTok{  }\KeywordTok{unnest}\NormalTok{(}\DataTypeTok{cols =}\NormalTok{ cols)}

\NormalTok{fhs_sample}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fhs_sample }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ age, }\DataTypeTok{y =}\NormalTok{ sysbp, }\DataTypeTok{group =}\NormalTok{ randid, }
             \DataTypeTok{color =}\NormalTok{ sex)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Systolic blood pressure (mmHg)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fhs_sample }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(sex, age, cursmoke, bmi, educ, sysbp) }\OperatorTok{%>%}\StringTok{ }
...
\NormalTok{fhs_sample }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(age, cursmoke, bmi, educ, sysbp) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{cor}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggcorrplot}\NormalTok{(}\DataTypeTok{method =} \StringTok{"circle"}\NormalTok{, }\DataTypeTok{type =} \StringTok{"lower"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(randid) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{educ =} \KeywordTok{first}\NormalTok{(educ), }
            \DataTypeTok{sysbp =} \KeywordTok{mean}\NormalTok{(sysbp, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ educ, }\DataTypeTok{y =}\NormalTok{ sysbp, }\DataTypeTok{group =}\NormalTok{ educ)) }\OperatorTok{+}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{int_only_fe_mod <-}\StringTok{ }\NormalTok{fhs_sample }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{glm}\NormalTok{(sysbp }\OperatorTok{~}\StringTok{ }\DecValTok{1}\NormalTok{, }\DataTypeTok{data =}\NormalTok{ .) }
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(broom)}
\NormalTok{int_only_fe_mod }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{augment}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ fhs_sample) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ age, }\DataTypeTok{color =}\NormalTok{ sex)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ sysbp), }\DataTypeTok{linetype =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ .fitted), }\DataTypeTok{linetype =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Systolic blood pressure (mmHg)"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{randid, }\DataTypeTok{ncol =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{int_only_mm_mod <-}\StringTok{ }\NormalTok{fhs_sample }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lmer}\NormalTok{(sysbp }\OperatorTok{~}\StringTok{ }\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{|}\StringTok{ }\NormalTok{randid), }\DataTypeTok{data =}\NormalTok{ .) }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{int_only_mm_mod }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{augment}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ fhs_sample) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ age, }\DataTypeTok{color =}\NormalTok{ sex)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ sysbp), }\DataTypeTok{linetype =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ .fitted), }\DataTypeTok{linetype =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{int_only_mm_mod }\OperatorTok{%>%}
...
\begin{Highlighting}[]
\NormalTok{int_only_mm_mod }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{augment}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ fhs_sample)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{age_mm_mod <-}\StringTok{ }\NormalTok{fhs_sample }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lmer}\NormalTok{(sysbp }\OperatorTok{~}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{|}\StringTok{ }\NormalTok{randid), }\DataTypeTok{data =}\NormalTok{ .) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{age_mm_mod }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{augment}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ fhs_sample) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ age, }\DataTypeTok{color =}\NormalTok{ sex)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ sysbp), }\DataTypeTok{linetype =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ .fitted), }\DataTypeTok{linetype =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ .fixed), }\DataTypeTok{linetype =} \DecValTok{3}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Systolic blood pressure (mmHg)"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{randid, }\DataTypeTok{ncol =} \DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{full_mm_mod <-}\StringTok{ }\NormalTok{fhs_sample }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lmer}\NormalTok{(sysbp }\OperatorTok{~}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{bmi }\OperatorTok{+}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{educ }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{|}\StringTok{ }\NormalTok{randid), }
       \DataTypeTok{data =}\NormalTok{ .) }

\NormalTok{full_mm_mod }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summary}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{full_mm_mod }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{confint.merMod}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{full_mm_mod_alldata <-}\StringTok{ }\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lmer}\NormalTok{(sysbp }\OperatorTok{~}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{bmi }\OperatorTok{+}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{educ }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{|}\StringTok{ }\NormalTok{randid), }
       \DataTypeTok{data =}\NormalTok{ .) }

\NormalTok{full_mm_mod_alldata }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summary}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{full_mm_mod_alldata2 <-}\StringTok{ }\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lmer}\NormalTok{(sysbp }\OperatorTok{~}\StringTok{ }\NormalTok{age }\OperatorTok{*}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{bmi }\OperatorTok{+}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{educ }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{|}\StringTok{ }\NormalTok{randid), }
       \DataTypeTok{data =}\NormalTok{ .) }

\NormalTok{full_mm_mod_alldata2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summary}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{full_mm_mod_alldata3 <-}\StringTok{ }\NormalTok{fhs }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{educ =} \KeywordTok{as_factor}\NormalTok{(educ),}
         \DataTypeTok{educ =} \KeywordTok{fct_recode}\NormalTok{(educ, }
                           \DataTypeTok{lowest =} \StringTok{"1"}\NormalTok{, }
                           \DataTypeTok{middle_low =} \StringTok{"2"}\NormalTok{, }
                           \DataTypeTok{middle_high =} \StringTok{"3"}\NormalTok{, }
                           \DataTypeTok{highest =} \StringTok{"4"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lmer}\NormalTok{(sysbp }\OperatorTok{~}\StringTok{ }\NormalTok{age}\OperatorTok{*}\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{bmi }\OperatorTok{+}\StringTok{ }\NormalTok{cursmoke }\OperatorTok{+}\StringTok{ }\NormalTok{educ }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{|}\StringTok{ }\NormalTok{randid), }
       \DataTypeTok{data =}\NormalTok{ .) }

\NormalTok{full_mm_mod_alldata3 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{summary}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{age_mm_mod2 <-}\StringTok{ }\NormalTok{fhs_sample }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lmer}\NormalTok{(sysbp }\OperatorTok{~}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{|}\StringTok{ }\NormalTok{randid), }\DataTypeTok{data =}\NormalTok{ .) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{age_mm_mod2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{augment}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ fhs_sample) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ age, }\DataTypeTok{color =}\NormalTok{ sex)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ sysbp), }\DataTypeTok{linetype =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ .fitted), }\DataTypeTok{linetype =} \DecValTok{2}\NormalTok{) }\OperatorTok{+}\StringTok{ }
