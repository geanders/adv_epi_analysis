...
\StringTok{  }\KeywordTok{filter}\NormalTok{(term }\OperatorTok{==}\StringTok{ "smokban"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{rr =} \KeywordTok{exp}\NormalTok{(estimate), }
         \DataTypeTok{low_rr =} \KeywordTok{exp}\NormalTok{(estimate }\OperatorTok{-}\StringTok{ }\KeywordTok{qt}\NormalTok{(}\FloatTok{0.975}\NormalTok{, }\DataTypeTok{df =} \DecValTok{55}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{std.error), }
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-145-1.pdf}
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-146-1.pdf}
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-147-1.pdf}
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-148-1.pdf}
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-149-1.pdf}
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-165-1.pdf}
...
\includegraphics{adv_epi_analysis_files/figure-latex/unnamed-chunk-168-1.pdf}
