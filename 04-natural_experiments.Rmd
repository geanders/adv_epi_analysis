...
near_thres_mod %>% 
  ...
  mutate(rr = exp(estimate), 
         low_rr = exp(estimate - qt(0.975, df = 4) * std.error), 
...
near_thres_mod2 %>% 
  ...
  filter(term == "smokban") %>% 
  mutate(rr = exp(estimate), 
         low_rr = exp(estimate - qt(0.975, df = 10) * std.error), 
...
near_thres_mod3 %>% 
  ...
  filter(term == "smokban") %>% 
  mutate(rr = exp(estimate), 
         low_rr = exp(estimate - qt(0.975, df = 22) * std.error), 
...
int_ts_mod1 %>% 
  ...
  filter(term == "smokban") %>% 
  mutate(rr = exp(estimate), 
         low_rr = exp(estimate - qt(0.975, df = 56) * std.error), 
...
int_ts_mod1 %>% 
  ...
  filter(term == "smokban") %>% 
  mutate(rr = exp(estimate), 
         low_rr = exp(estimate - qt(0.975, df = 55) * std.error), 
